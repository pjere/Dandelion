...
# directions vues depuis CH : (frontière, index) — 0 = a→b, 1 = b→a
_IMP = [(b, 0 if b[1] == "CH" else 1) for b in NTC if "CH" in b]
_EXP = [(b, 0 if b[0] == "CH" else 1) for b in NTC if "CH" in b]
